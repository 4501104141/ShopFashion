...
public static class ModelBuilderExtensions
{
    public static void Seed(this ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<AppConfig>().HasData(
           new AppConfig() { Key = "HomeTitle", Value = "This is home page of ShopFashion" },
           new AppConfig() { Key = "HomeKeyword", Value = "This is keyword of ShopFashion" },
           new AppConfig() { Key = "HomeDescription", Value = "This is description of ShopFashion" }
           );
       ...
       new Product()
       {
        ...
        var adminId2 = new Guid("69BD714F-9576-45BA-B5B7-F00649BE99DE");
        ...
        modelBuilder.Entity<AppUser>().HasData(new AppUser
        {
            Id = adminId2,
            UserName = "hihihi",
            NormalizedUserName = "hihihi",
            Email = "tedu.hihihi@gmail.com",
            NormalizedEmail = "tedu.hihihi@gmail.com",
            EmailConfirmed = true,
            PasswordHash = hasher.HashPassword(null, "hihihi3Aa_"),
            SecurityStamp = string.Empty,
            FirstName = "Hihi",
            LastName = "Hihi",
            Dob = new DateTime(2020, 01, 31)
