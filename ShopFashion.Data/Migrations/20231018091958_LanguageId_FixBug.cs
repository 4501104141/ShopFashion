...
{
    public partial class LanguageId_FixBug : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OrderDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 10, 18, 16, 19, 58, 361, DateTimeKind.Local).AddTicks(3123)),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "HomeDescription", "This is description of ShopFashion" },
                    { "HomeKeyword", "This is keyword of ShopFashion" },
                    { "HomeTitle", "This is home page of ShopFashion" }
                });

            migrationBuilder.InsertData(
                table: "AppRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Description", "Name", "NormalizedName" },
                values: new object[] { new Guid("8d04dce2-969a-435d-bba4-df3f325983dc"), "d4fc9ea4-d8c4-4348-929a-0466166c3c51", "Administrator role", "admin", "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("69bd714f-9576-45ba-b5b7-f00649be00de"), 0, "bc84c09f-0933-4843-9e36-516ea45180ef", new DateTime(2020, 1, 31, 0, 0, 0, 0, DateTimeKind.Unspecified), "tedu.international@gmail.com", true, "Toan", "Bach", false, null, "tedu.international@gmail.com", "admin", "AQAAAAEAACcQAAAAEBzipOEM1Y8HjB4/sVjUSmHN3MKNFm0WBpRitTcGNqVEr/I888wGP8GIibyoFSVYBg==", null, false, "", false, "admin" },
                    { new Guid("69bd714f-9576-45ba-b5b7-f00649be99de"), 0, "cd132649-1448-4e5b-82f7-3794386e3fba", new DateTime(2020, 1, 31, 0, 0, 0, 0, DateTimeKind.Unspecified), "tedu.hihihi@gmail.com", true, "Hihi", "Hihi", false, null, "tedu.hihihi@gmail.com", "hihihi", "AQAAAAEAACcQAAAAEDc9nMsj0knM5HodJnabL7+8vm2hs9x7u74xLyMl8HcfsXzVoTbNEATn8ZlHzUqZbQ==", null, false, "", false, "hihihi" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2023, 10, 18, 16, 19, 58, 363, DateTimeKind.Local).AddTicks(3037), null, 100000m, 200000m });
