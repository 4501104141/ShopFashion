...
{
    public partial class NewTable_ProductImage : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OrderDate = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2023, 9, 18, 22, 56, 28, 814, DateTimeKind.Local).AddTicks(5829)),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2023, 9, 18, 22, 56, 28, 830, DateTimeKind.Local).AddTicks(917), 100000m, 200000m, null });
